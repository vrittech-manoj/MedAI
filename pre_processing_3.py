...
for num in [1,2,3,4,5,6,7]:
    ...
    print(f"[✅ Success: total good: {good_data} ,one added error: {one_added_error} ,total fifty_six_data: {fifty_six_data} , total bad:{bad_data}, total data:{len(rows)}")

print("*********************************************")
print(f"[✅ Success: total good: {total_good} ,total bad:{total_bad},total one added error:{total_one_added_error} ,total fifty six:{total_fifty_six_data}, total data:{total_data}")
